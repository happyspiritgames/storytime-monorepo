...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.StoryTimeReaderApi.Destination = factory(root.StoryTimeReaderApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('sceneKey')) {
        obj['sceneKey'] = ApiClient.convertToType(data['sceneKey'], 'String');
      }
  ...
  /**
   * @member {String} sceneKey
   */
  exports.prototype['sceneKey'] = undefined;
  /**
